...
st.write('This app displays a variety of Seaborn plots created by ALEEM SHAIKH exploring the Tips dataset,which includes data on restaurant bills and tips.')
...
def violin_plot(ax):
    ...
    ax.set_title('Violin Plot: Total Bill by Day and Smoker Status')
...
def hist_plot(ax):
    ...
    ax.set_title('Historam: Distribution of Total Bill')
...
joint_fig = sns.jointplot(data=tips,x='total_bill',y='tip',kind='scatter',palette='coolwarm')
...
display_plot('Swarn Plot',swarm_plot)
